 ...
 */
@NonNullByDefault
public class MagentaTVHandler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(MagentaTVHandler.class);

    @Nullable
    private MagentaTVConfiguration config;

    public MagentaTVHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        ...
        config = getConfigAs(MagentaTVConfiguration.class);
